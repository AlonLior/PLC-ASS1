...
class MyTestCase(unittest.TestCase):
    ...
    def test_union_1_empty_2_null(self):
        testargs = ['Ex1', 'UNION', r'blabla', r'files\emptyfile.txt', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'file 1 or file 2 does not exist'
    ...
    def test_union_1_empty_2_null(self):
        testargs = ['Ex1', 'UNION', r'files\emptyfile.txt', r'blabla', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'file 1 or file 2 does not exist'
    ...
    def test_union_1_empty_2_csv(self):
        testargs = ['Ex1', 'UNION', r'files\noending', r'files\emptyfile.csv', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
    ...
    def test_union_1_txt_2_no(self):
        testargs = ['Ex1', 'UNION', r'files\emptyfile.csv', r'files\noending', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'input files in the wrong formats'
    ...
    def test_union_1_txt_2_csv(self):
        testargs = ['Ex1', 'UNION', r'files\emptyfile.txt', r'files\emptyfile.csv', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
    ...
    def test_union_1_csv_2_txt(self):
        testargs = ['Ex1', 'UNION', r'files\emptyfile.csv', r'files\emptyfile.txt', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'files extensions should be the same'
    ...
    def test_union_1_empty_2_full(self):
        testargs = ['Ex1', 'UNION', r'files\emptyfile.txt', r'files\items.txt', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
    ...
    def test_union_1_full_2_empty(self):
        testargs = ['Ex1', 'UNION', r'files\items.txt', r'files\emptyfile.txt', 'bla']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'Error! The table\'s format does not match'
    ...
    def test_union_bad_structure_1(self):
        testargs = ['Ex1', 'UNION', r'files\users.txt', r'files\bad_structure.txt', 'bla.txt']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'files\\bad_structure.txt structure is not consistent, different number of attributes'

    def test_union_bad_structure_2(self):
        testargs = ['Ex1', 'UNION', r'files\users.txt', r'files\bad_structure_2.txt', 'bla.txt']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'files\\bad_structure_2.txt structure is not consistent, different number of attributes'

    def test_union_bad_structure_3(self):
        testargs = ['Ex1', 'UNION', r'files\users.txt', r'files\bad_structure_3.txt', 'bla.txt']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
        assert capturedOutput.buflist[0] == 'files\\bad_structure_3.txt structure is not consistent, different number of attributes'

    def test_union_diffrent_types_str_int(self):
        testargs = ['Ex1', 'UNION', r'files\users.txt', r'files\users (2).txt', 'bla.txt']
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        parse_args(testargs)
